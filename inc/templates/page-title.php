...
if( is_singular() && get_post_type() == 'tp_event' ) {
	$custom_title = get_the_title();
	if( $thumbnail = get_the_post_thumbnail_url() && empty( $cate_top_image ) ) {
		$cate_top_image_src = $thumbnail;
	}
}
...
if( function_exists('bp_is_active') ) {
	...
	if( is_buddypress() ) {
		...
		if( bp_is_active( 'groups' ) && bp_is_group() ) {
			...
			$cate_top_image_src = $group_cover_image_url;
			...
			if( bp_attachments_get_user_has_cover_image() ) {
				...
				$cate_top_image_src = $user_cover_image_url;
