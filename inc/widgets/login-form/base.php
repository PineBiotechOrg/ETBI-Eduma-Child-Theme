...
<?php if ( isset( $_GET['result'] ) || isset( $_GET['action'] ) ) : ?>
	...
	<?php if ( ! empty( $_GET['action'] ) && $_GET['action'] == 'register' ) : ?>
		<?php if ( get_option( 'users_can_register' ) ) : ?>
			...
			<?php if ( ! empty( $_GET['empty_firstname'] ) ) : ?>
				<?php echo '<p class="message message-error">' . esc_html__( 'Please enter a first name!', 'eduma' ) . '</p>'; ?>
			<?php endif; ?>

			<?php if ( ! empty( $_GET['empty_lastname'] ) ) : ?>
				<?php echo '<p class="message message-error">' . esc_html__( 'Please enter a last name!', 'eduma' ) . '</p>'; ?>
			<?php endif; ?>
			...
			<div class="thim-login form-submission-register">
				...
				<form class="<?php if ( get_theme_mod( 'thim_auto_login', true ) ) {
					...
					<p>
						<input placeholder="<?php esc_attr_e( 'First Name', 'eduma' ); ?>" type="text" name="user_firstname" class="input required" />
					</p>

					<p>
						<input placeholder="<?php esc_attr_e( 'Last Name', 'eduma' ); ?>" type="text" name="user_lastname" class="input required" />
					</p>
