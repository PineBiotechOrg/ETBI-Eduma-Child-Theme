...
<div class="user-info">
	...
	<div class="user-information">
		...
		<div class="author-badge"><?php if( function_exists( 'learnpress_render_user_badge' ) ) learnpress_render_user_badge( $user->user->data->ID ); ?></div>

        <div class="user-extra-pages">
            <a href="/user-history/">Point History</a>
        </div>
