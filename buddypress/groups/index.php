...
<div id="buddypress">
	...
	<form action="" method="post" id="groups-directory-form" class="dir-form">
		...
		<div class="item-list-tabs groups-archive-tabs" aria-label="<?php esc_attr_e( 'Groups directory main navigation', 'buddypress' ); ?>">
			<ul>
		...
		<div class="item-list-tabs" id="subnav" aria-label="<?php esc_attr_e( 'Groups directory secondary navigation', 'buddypress' ); ?>" role="navigation">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<label for="groups-order-by" class="group-filter-select-label"><?php _e( 'Order By:', 'buddypress' ); ?></label>

					<select id="groups-order-by" class="group-filter-select">
