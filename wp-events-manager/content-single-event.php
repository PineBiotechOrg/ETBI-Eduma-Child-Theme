    ...
    <div class="summary entry-summary">
        ...
        <div class="tp-event-content">
        	...
        	<?php
				...
				$location_link = get_post_meta( get_the_ID(), 'tp_event_location_link', true ) ? get_post_meta( get_the_ID(), 'tp_event_location_link', true ) : '';
			?>
            <div class="tp-event-info">
                <div class="tp-info-box col col-sm-12 col-md-4 col-lg-4">
                    <p class="heading">
                ...
                <div class="tp-info-box col col-sm-12 col-md-4 col-lg-4">
                    ...
                    <?php 
                    	...
                    	if( ! empty( $location_link ) ) {
                    		...
                    		$location = '<p><a href="'.esc_url( $location_link ).'">'. esc_html( $location ) .'</a></p>';

                    	} else {

                    		$location = '<p>'. esc_html( $location ) .'</p>';
                ...
                <?php }?>
                <div class="tp-info-box col col-sm-12">
                	<?php
                	/**
		...
		<?php if ( $team->have_posts() ) : ?>
            <div class="tp-event-organizers">
                <h3 class="title"><?php apply_filters( 'etbi_participants_title', esc_html_e( 'Program Organizers', 'eduma' ) ); ?></h3>
